<template>
  <div class="components-container">
    <aside>
      <a href="https://github.com/PanJiaChen/vue-countTo" target="_blank">计数器组件</a>
    </aside>
    <count-to
      ref="example"
      :start-val="_startVal"
    ...
    <div style="margin-left: 25%;margin-top: 40px;">
      ...
      <label class="label" for="durationInput">持续时间:
      ...
      <br>
      <label class="label" for="decimalsInput">小数位数:
        <input v-model.number="setDecimals" type="number" name="decimalsInput">
      </label>
      <label class="label" for="separatorInput">分隔符:
